import os
import sys
# from PySide2.QtGui import QSplitter

from PyQt5 import QtWidgets, QtGui, QtCore
from PyQt5 import uic
from read_db import get_images, download_section
from source import image_file
from source.thread.download_thread import file_thread
...
class books_main_page(QtWidgets.QMainWindow):
    ...
    def books_details_section(self):
        ...
        for data_ in data:
            ...
            data = urllib.request.urlopen(data_[0]).read()
    ...
    def show_images(self):
        ...
        for data in image_list:
            for keys, v in data.items():
                # print ">>>>>>>>>>>>>>>>>> show image", data.get(keys)
    ...
    def add_button_in_list(self):
        ...
        # print ">>>>>>>>>>> get last item text", max(number_list)
